...
class CSalamanderDebugAbstract
{
  public:
    ...
    // Pokud jiz nejsme pripojeni na Altap Trace Server, zkusi navazat spojeni (server
...
//
// Altap Salamander 1.6 or Later Plugin Entry Point Function Type,
...
//
// Altap Salamander 2.5 Beta 2 or Later Plugin Get Required Version of Salamander Function Type,
...
//
// Altap Salamander 2.52 beta 2 (PB 22) or Later Plugin Get SDK Version Function Type,
...
\
  ...
  { \
    switch (funx) \
    { \
      case M1xA_FV_GREAT: a = *p; break; \
      case M1xA_FV_LESS:  b = *p; break; \
    } \
\
    *p = (T)((a + b) / 2); \
\
