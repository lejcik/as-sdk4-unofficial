...
// Toto bitové pole slouží jako kontext pøedávaný do jednotlivých metod. Pro jednu
// logickou skupinu operací (napøíklad vybalování více souborù z archivu) pøedává
// volající stejné bitové pole, které na zaèátku inicializuje na hodnotu 0.
